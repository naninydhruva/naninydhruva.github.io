...
export default function Projects() {
  ...
  const projects = [
    {
      title: "Contentful CLI Migration Suite",
      period: "Open Source",
      description:
        "Comprehensive production-ready CLI tools for managing Contentful CMS content with advanced migration, intelligent publishing, GraphQL queries, and automated validation capabilities",
      tech: ["Node.js", "JavaScript", "Contentful API", "GraphQL", "REST APIs", "CLI"],
      highlights: [
        "Advanced entry & asset migration between spaces with configurable depth",
        "Content type transformation with field mapping and locale handling",
        "GraphQL API queries for complex content filtering & data extraction",
        "Smart publishing with pagination, validation error tracking & link cleaning",
        "Entry deletion mapping with configurable rules & smart policies",
        "Rate limiting & exponential backoff for API reliability",
        "Cross-space asset migration with automatic file download/upload",
        "Comprehensive logging, error handling & detailed reporting",
        "Support for multiple environments (UK, DE, FR, Mobile App)",
      ],
      gradient: "from-blue-600 via-indigo-600 to-purple-600",
      IconComponent: Code2,
      github: "https://github.com/naninydhruva/contentful-cli-migration",
      impact: "6,600+",
      impactLabel: "Entries Managed",
    },
    {
